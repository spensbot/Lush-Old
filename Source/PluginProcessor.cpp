...
{
    std::make_unique<AudioParameterFloat> ("dryGain", "Dry Gain", -100.0f, 6.0f, -12.0f),
    std::make_unique<AudioParameterFloat> ("wetGain", "Wet Gain", -100.0f, 6.0f, -12.0f),
    std::make_unique<AudioParameterFloat> ("delayFeedback", "Delay Feedback", 0.0f, 1.0f, 0.5f),
    std::make_unique<AudioParameterFloat> ("delayTime", "Delay Time", 0.01f, 1.0f, 0.5f),
    std::make_unique<AudioParameterFloat> ("delayModDepth", "Delay Mod Depth", 0.0f, 10.0f, 0.0f),
    std::make_unique<AudioParameterFloat> ("delayModFrequency", "Delay Mod Frequency", 0.0f, 10.0f, 2.0f),
    std::make_unique<AudioParameterFloat> ("spacing", "Spacing", 0.0f, 1.0f, 0.5f),
